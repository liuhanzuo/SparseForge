"""
Qwen model wrapper with SparseLinear replacement, aligned with GPT pipeline.
Loads HuggingFace Qwen2/Qwen2.5/Qwen3 weights and optionally distills using teacher.

Supported models:
- Qwen/Qwen2-0.5B, Qwen/Qwen2-1.5B, Qwen/Qwen2-7B
- Qwen/Qwen2.5-0.5B, Qwen/Qwen2.5-1.5B, Qwen/Qwen2.5-3B, Qwen/Qwen2.5-7B, Qwen/Qwen2.5-14B
...
class QwenSparse(nn.Module):
    ...
    def from_pretrained(
        ...
        *,
        ...
        # Use AutoConfig to support Qwen2, Qwen2.5, and Qwen3 models
        ...
        # Use AutoModelForCausalLM to support Qwen2, Qwen2.5, and Qwen3 models
        ...
        # IMPORTANT: Model is loaded to CPU by default (no device_map needed).
    ...
    def estimate_mfu(self, fwdbwd_per_iter: int, dt: float) -> float:
        # Approximate using GPT-style formula; Qwen arch specifics are similar to LLaMA.
